...
export default function AboutMePage() {
  const { page, stats, manifesto, developerProfile, values, milestones, workflow, passions, cta } =
    ABOUT_DATA;
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-14 pb-8">
        ...
        <header className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl space-y-4">
            ...
            <h1 className="text-headline-lg-responsive text-foreground">
              {page.heading} <span className="text-primary">{page.headingAccent}</span>
            </h1>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={stat.label} className="flex items-center gap-2">
                  <span aria-hidden className={`inline-flex size-2 rounded-full ${dotColor}`} />
        ...
        <AboutManifesto manifesto={manifesto} developerProfile={developerProfile} />
