        ...
        <div className='max-w-2xl space-y-6'>
          ...
          <ul className='flex flex-wrap gap-2'>
            {ENGINEERING.technologies.map((technology) => (
              <li
                key={technology.name}
                className='flex items-center gap-1.5 rounded-full border border-border/60 bg-background/60 px-3 py-1.5 text-[0.68rem] font-medium tracking-widest text-on-surface-variant backdrop-blur transition-colors duration-300 hover:border-primary/40 hover:text-on-surface'
              >
                <span
                  aria-hidden
