      ...
      <div className="relative overflow-x-auto p-4 sm:p-6 font-mono text-xs leading-relaxed text-on-surface sm:text-[0.8125rem]">
        <pre className="selection:bg-primary/30 selection:text-white">
          <code>
            ...
            <span className="text-emerald-300">&apos;Full-Stack &amp; UI Developer&apos;</span>,
            {"\n"}  <span className="text-on-surface-variant">location</span>:{" "}
            <span className="text-emerald-300">&apos;Polska (CET / UTC+1)&apos;</span>,
            ...
            <span className="text-emerald-300">&apos;Tailwind CSS v4&apos;</span>,{" "}
            ...
            <span className="text-emerald-300">&apos;Server Components&apos;</span>,{" "}
            ...
            {"\n"}    <span className="text-emerald-300">&apos;Pixel-perfect precision&apos;</span>,
            {"\n"}    <span className="text-emerald-300">&apos;Sub-100ms interactions&apos;</span>,
            {"\n"}    <span className="text-emerald-300">&apos;Clean &amp; maintainable code&apos;</span>,
            {"\n"}    <span className="text-emerald-300">&apos;Empathetic user experience&apos;</span>
            {"\n"}  ],
            {"\n"}  <span className="text-on-surface-variant">status</span>:{" "}
            <span className="text-yellow-300">&apos;Ready for ambitious challenges&apos;</span>
            {"\n"}&#125;;
          </code>
        </pre>
      </div>
