      ...
      <form action={formAction} className="flex flex-col gap-6 p-5 sm:p-7">
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className={fieldClassName(Boolean(state.fieldErrors.message), "min-h-36 resize-y py-3")}
          />
          <FieldError id={`${formId}-message-error`} message={state.fieldErrors.message} />
        </div>
...
function ChoiceGroup({
  ...
  return (
    <fieldset className="flex flex-col gap-3">
      <legend className="text-label text-on-surface-variant/80">{legend}</legend>
      <div
        role="group"
