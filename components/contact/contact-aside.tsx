        ...
        <div className="relative flex flex-col gap-4">
          ...
          <dl className="grid grid-cols-2 gap-3 text-sm">
            <div className="flex items-start gap-2 text-on-surface-variant">
              ...
              <div>
                <dt className="text-label text-on-surface-variant/55">Odpowiedź</dt>
                <dd className="mt-1 text-on-surface">{availability.responseTime}</dd>
              </div>
            </div>
            <div className="flex items-start gap-2 text-on-surface-variant">
              <MapPin aria-hidden className="mt-0.5 size-3.5 text-primary" />
              <div>
                <dt className="text-label text-on-surface-variant/55">Lokalizacja</dt>
                <dd className="mt-1 text-on-surface">{availability.location}</dd>
              </div>
            </div>
          </dl>
        </div>
